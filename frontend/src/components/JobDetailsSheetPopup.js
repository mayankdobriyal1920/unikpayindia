...
import {briefcaseOutline, locationOutline, cashOutline, shareSocialOutline} from 'ionicons/icons';
    ...
    return (
        ...
        >
            <IonHeader className="job_detail_sheet_header">
                <IonToolbar>
                    <IonTitle className="job_detail_sheet_header_text">
                        <IonItem className="job-basic-info-image">
                            <img alt={"company"} src={jobDetailsData?.img_url}/>
                            <IonLabel>{jobDetailsData.company}</IonLabel>
                        </IonItem>
                    </IonTitle>
                    <IonButtons slot="end">
                        <IonButton>
            ...
            <IonContent className="ion-padding job_detail_sheet_content">
                ...
                <div className="job-description">
                    ...
                    <p>Frontend Web Developer with strong experience in Backbone.js, React.js, Bootstrap, HTML5, JavaScript and jQuery.</p>
            ...
            <IonFooter className="job_detail_sheet_footer ion-padding">
                <IonButton expand="block" color="primary" className="apply-btn">Apply</IonButton>
                <IonButton expand="block" fill="outline" onClick={onDidDismiss}>Close</IonButton>
            </IonFooter>
        </IonModal>
    );
}
