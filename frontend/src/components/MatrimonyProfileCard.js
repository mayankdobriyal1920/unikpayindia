...
export default function MatrimonyProfileCard({ profile,handleProfileItemClick,selectedId }) {
    return (
        <div className={`matrimony-card ${selectedId === profile?.id ? 'active' : ''}`} onClick={()=>handleProfileItemClick(profile)}>
