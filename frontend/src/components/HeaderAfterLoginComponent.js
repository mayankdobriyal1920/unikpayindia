...
import {
    ...
    newspaperSharp,
    cashSharp,
    medalSharp, notificationsSharp, logOutSharp,
} from 'ionicons/icons';
...
const HeaderAfterLoginComponent = ({pageId,hideHeader,menuRef,setCurrentPath}) => {
    ...
    const goToPage =(page)=>{
        if (page.startsWith('http')) {
            window.location.href = page; // full page redirect for external links
        } else {
            history.replace(page); // your router’s navigate for internal routes
        }
        setCurrentPath(page);
                    ...
                    <IonContent>
                        <div className="with_login-mobile-menu">
                            ...
                            <div className="menu-section">
                                ...
                                {/*    <IonButton className="logout_button_menu"*/}
                                {/*               onClick={() => callFunctionToLogoutUser()}>Logout</IonButton>*/}
                                {/*</div>*/}
                            </div>
                    </IonContent>
                </IonMenu>
                ...
                <IonToolbar className="with_login-toolbar">
                    ...
                    {!isMobile && (
                        <IonButtons slot="start" className="with_login-desktop-menu">
                            {menuDesktopItems.map((item, index) => (
                            ...
                            <div onClick={() => callFunctionToLogoutUser()}
                                 className={`with_login-menu-item`}>
                                {/*<IonIcon className={"top_header_icon"} icon={logOutSharp}/>*/}
                                <span>Log Out</span>
                            </div>
                        </IonButtons>
                    )}
