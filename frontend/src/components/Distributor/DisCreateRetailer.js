...
export default function DisCreateRetailer() {
                                ...
                                <form>
                                    ...
                                    <div className="form-row mt-5 m-auto">
                                        <div className="form-group col-6">
                                            <input type="text" placeholder="Residential Address" className="form-control form-control-md"/>
                                        </div>

                                        <div className="form-group col-6">
                                            <input type="text" placeholder="Outlet Address" className="form-control form-control-md"/>
                                        </div>
                                    </div>
                                    <div className="form-row mt-5 m-auto">
                                        <div className="form-group col-6">
                                        ...
                                        <div className="form-group col-6">
                                            <input type="text" placeholder="Outlet Pin Code" className="form-control form-control-md"/>
                                        </div>
                                    </div>
                                    <div className="form-row mt-5 m-auto">
                                        <div className="form-group col-6">
                                            <input type="text" placeholder="DOB" className="form-control form-control-md"/>
                                        </div>
