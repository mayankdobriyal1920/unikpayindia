...
export default function MasterCreditDebitReport(){
    return(
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-md-flex d-block align-items-center justify-content-between my-3 page-header-breadcrumb">
                            <div className="left-content">
                                <h3 className="content-title  mt-2">Manage Credit/Debit Report</h3>
                                <div className="d-flex p-0">
                                    <i className="fa-solid fa-house"></i>
                                    <p className="text-muted mb-0 hover-cursor">Master Distributor / Credit/Debit Report</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="card-body card-tabs-new">
                                        <ul className="nav nav-pills light" role="tablist">
                                            <li className=" nav-item" role="presentation">
                                                <a href="#master-creditreport" className="nav-link active" data-bs-toggle="tab"
                                                   aria-expanded="false" aria-selected="true" role="tab">Credit Report</a>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                                <a href="#debit-creditreport" className="nav-link" data-bs-toggle="tab"
                                                   aria-expanded="false" aria-selected="false" role="tab" tabIndex="-1">Debit Report</a>
                                            </li>
                                            <li className="nav-item" role="presentation">
                                                <a href="#master-upifunds" className="nav-link" data-bs-toggle="tab"
                                                   aria-expanded="false" aria-selected="false" role="tab" tabIndex="-1">UPI Funds</a>
                                            </li>
                                        ...
                                        <div className="tab-content white-bgcolor">
                                            <div id="master-creditreport" className="tab-pane active show bsstdmt" role="tabpanel">
                                                <div className="">
                                                    <form>
                                            ...
                                            <div id="debit-creditreport" className="tab-pane" role="tabpanel">
                                                <div className="">
                                                    <form>
                                                        <div className="form-row mt-5 m-auto">
                                                            <div className="form-group col-4">
                                            ...
                                            <div id="master-upifunds" className="tab-pane" role="tabpanel">
                                                <div className="">
                                                    <form>
                                                        <div className="form-row mt-5 m-auto">
                                                            <div className="form-group col-4">
