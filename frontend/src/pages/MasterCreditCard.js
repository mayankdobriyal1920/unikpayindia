...
export default function MasterCreditCard(){
    return(
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-md-flex d-block align-items-center justify-content-between my-3 page-header-breadcrumb">
                            <div className="left-content">
                                <h3 className="content-title  mt-2">Credit Card</h3>
                                <div className="d-flex p-0">
                                    <i className="fa-solid fa-house"></i>
                                    <p className="text-muted mb-0 hover-cursor">Master Distributor / Credit Card</p>
                                </div>
                            </div>
                        </div>
