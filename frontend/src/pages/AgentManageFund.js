                                ...
                                <div className="card retailer-home-balance">
                                    ...
                                    <div className="card-body card-tabs-new">
                                        <ul className="nav nav-pills light" role="tablist">
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <a href="#upi-fund" className="nav-link" data-bs-toggle="tab"
                                                   aria-expanded="true" aria-selected="false" role="tab" tabIndex="-1">UPI Funds</a>
                                            </li>
                                        ...
                                        <div className="tab-content white-bgcolor">
                                            ...
                                            <div id="upi-fund" className="tab-pane" role="tabpanel">
                                                <div className="">
