...
export default function DistManageFundWithdraw(){
    return(
                                                                ...
                                                                <div className="table-responsive">
                                                                    <table className="table border-dashed table-responsive-sm">
                                                                        ...
                                                                        <tr className="LightBlue-BgColor">
                                                                            ...
                                                                            <th scope="col" className="text-end">Debit From </th>
                                                                        ...
                                                                        <tr className="table-bordered ">
                                                                            ...
                                                                            <td className="text-end">Account Credited By#20092521452821 </td>
